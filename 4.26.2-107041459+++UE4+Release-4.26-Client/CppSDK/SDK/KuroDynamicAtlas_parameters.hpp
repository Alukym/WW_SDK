...
public:
	...
	TDelegate<void(const TArray<struct FDynamicAtlasSlotManagedHandle>& ManagedHandle)> CompleteCallback;                                  // 0x0020(0x0014)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0034(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1A8E[0x3];                                     // 0x0035(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(DynamicAtlasBlueprintLibrary_AddTextureAsync) == 0x000038, "Wrong size on DynamicAtlasBlueprintLibrary_AddTextureAsync");
...
static_assert(offsetof(DynamicAtlasBlueprintLibrary_AddTextureAsync, ReturnValue) == 0x000034, "Member 'DynamicAtlasBlueprintLibrary_AddTextureAsync::ReturnValue' has a wrong offset!");
...
public:
	class FString                                 InAtlasTag;                                        // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDynamicTextureAtlasSetting            InSetting;                                         // 0x0010(0x0028)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(DynamicAtlasBlueprintLibrary_SetOverrideSetting) == 0x000038, "Wrong size on DynamicAtlasBlueprintLibrary_SetOverrideSetting");
