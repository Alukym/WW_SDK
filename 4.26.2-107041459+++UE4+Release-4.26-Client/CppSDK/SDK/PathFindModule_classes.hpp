...
public:
	...
	uint8                                         Pad_1A93[0x4];                                     // 0x005C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1A94[0x20];                                    // 0x0030(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FIntPoint, class ANavmeshPartitionActor*> LoadedNavPartitionActorsMap;                       // 0x0050(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TSet<class ANavmeshPartitionActor*>           ToAddActorSet;                                     // 0x00A0(0x0050)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1A95[0x50];                                    // 0x00F0(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNavigationPartitionSystem) == 0x000140, "Wrong size on UNavigationPartitionSystem");
static_assert(offsetof(UNavigationPartitionSystem, LoadedNavPartitionActorsMap) == 0x000050, "Member 'UNavigationPartitionSystem::LoadedNavPartitionActorsMap' has a wrong offset!");
static_assert(offsetof(UNavigationPartitionSystem, ToAddActorSet) == 0x0000A0, "Member 'UNavigationPartitionSystem::ToAddActorSet' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1A96[0x38];                                    // 0x0030(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
