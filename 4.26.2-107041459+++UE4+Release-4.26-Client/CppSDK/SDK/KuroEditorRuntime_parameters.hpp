...
public:
	...
	uint8                                         Pad_1778[0x3];                                     // 0x0005(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	TDelegate<void(bool Success, int32 Code, const class FString& Data)> Handler;                                           // 0x0080(0x0014)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1779[0x4];                                     // 0x0094(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(EditorRuntimeOperations_SendHttpRequest) == 0x000098, "Wrong size on EditorRuntimeOperations_SendHttpRequest");
