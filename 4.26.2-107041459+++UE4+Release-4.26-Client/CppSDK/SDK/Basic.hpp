...
namespace Offsets
{
	constexpr int32 GObjects          = 0x07DE6568;
	constexpr int32 AppendString      = 0x023A4B40;
	constexpr int32 GNames            = 0x07DADA80;
	constexpr int32 GWorld            = 0x08016488;
	constexpr int32 ProcessEvent      = 0x025A75B0;
